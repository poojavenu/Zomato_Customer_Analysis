...
select sales.userid, sum(product.price) total_amt_spent
from sales 
inner join product
...
9. if buying each product generates points for eg 5rs=2 zomato point and each product has different purchasing
points for p1 5rs=1 zomato point, for p2 10rs=5zomato point and p3 5rs=1 zomato point, 2rs=1zomato point
...
10. in the 1st 1 yr after a customer joins the gold program (including their joining date) irrespective of 
what the customer has purchased they earn 5 zomato points for every 10rs spent who earned more 1 or 3
and what was their points earnings in their 1st year?
1 ponit = 2rs
